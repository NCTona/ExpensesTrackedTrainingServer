...
# Gom dữ liệu nhiều user thành 1 tập lớn
...
# =========================
# BUILD MODEL (LSTM + USER EMBEDDING)
# =========================
...
# FIX: dùng Flatten thay cho tf.squeeze
user_embedding = Flatten(name="user_embedding_flat")(user_embedding)

ts_features = LSTM(64, activation="tanh")(ts_input)
...
# TRAIN + MLFLOW
# =========================
mlflow.set_experiment("Expense Forecasting - LSTM User Embedding")
